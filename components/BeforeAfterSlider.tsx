...
export const BeforeAfterSlider = ({ before, after }: { before: string; after: string }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 left-3 md:top-4 md:left-4 bg-black/60 backdrop-blur-md px-3 py-1 md:px-4 md:py-1.5 rounded-full text-[9px] md:text-[10px] font-bold text-white uppercase tracking-widest pointer-events-none transition-opacity group-hover:opacity-100 opacity-80">Voor</div>
      <div className="absolute top-3 right-3 md:top-4 md:right-4 bg-primary/90 backdrop-blur-md px-3 py-1 md:px-4 md:py-1.5 rounded-full text-[9px] md:text-[10px] font-bold text-white uppercase tracking-widest pointer-events-none transition-opacity group-hover:opacity-100 opacity-80">Na</div>
    </div>
  );
};
