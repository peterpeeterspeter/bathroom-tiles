...
export default function PrivacyPage() {
  return (
    <>
      <Helmet>
        <title>Privacyverklaring - De Badkamer</title>
        <meta name="description" content="Privacyverklaring van DeBadkamer.com. Lees hoe wij omgaan met uw persoonsgegevens." />
      </Helmet>
